...
const FAMOUS: GeneralCatalogEntry[] = [
  ...
  G("zhuge_liang", "诸葛亮", "蜀", "ping", "sorcerer", 10, 24, 100, 108, "卧龙，隆中对三分天下，赤壁借东风。"),
  ...
  G("pang_tong", "庞统", "蜀", "ping", "sorcerer", 7, 22, 94, 95, "凤雏，与孔明齐名，殒于落凤坡。"),
  G("fa_zheng", "法正", "蜀", "ping", "sorcerer", 7, 26, 88, 98, "取蜀定计，汉中策动黄忠斩将。"),
  ...
  G("si_ma_yi", "司马懿", "魏", "ping", "sorcerer", 10, 32, 98, 118, "隐忍老谋，高平陵后掌魏权柄。"),
  ...
  G("guo_jia", "郭嘉", "魏", "ping", "sorcerer", 7, 18, 96, 88, "鬼才，遗计定辽东。"),
  G("xun_yu", "荀彧", "魏", "ping", "sorcerer", 7, 22, 94, 92, "王佐，曹魏后方栋梁。"),
  G("jia_xu", "贾诩", "魏", "ping", "sorcerer", 8, 20, 96, 95, "毒士，算无遗策全身而退。"),
  G("simazhao", "司马昭", "魏", "ping", "sorcerer", 8, 28, 88, 105, "司马氏代魏之渐。"),
  G("sun_quan", "孙权", "吴", "shui", "archer", 8, 55, 82, 110, "紫髯碧眼，据江东三世。"),
  G("zhou_yu", "周瑜", "吴", "shui", "sorcerer", 9, 72, 94, 105, "美周郎，赤壁火攻破曹。"),
  G("lu_su", "鲁肃", "吴", "shui", "sorcerer", 7, 24, 90, 98, "榻上策，联刘抗曹。"),
  G("lu_meng", "吕蒙", "吴", "shui", "infantry", 8, 76, 80, 108, "白衣渡江，擒关羽。"),
  G("lu_xun", "陆逊", "吴", "shui", "sorcerer", 8, 30, 96, 102, "夷陵火攻，书生拜将。"),
  ...
  G("diao_chan", "貂蝉", "群", "ping", "sorcerer", 5, 22, 88, 75, "连环计，演义传奇人物。"),
  ...
  G("zhang_jiao", "张角", "黄巾", "ping", "sorcerer", 8, 34, 92, 108, "太平道，黄巾起事。"),
  ...
  G("chen_gong", "陈宫", "吕", "ping", "sorcerer", 6, 20, 90, 90, "弃曹从吕，白门楼殉义。"),
  ...
  G("xu_shu", "徐庶", "蜀", "ping", "sorcerer", 7, 48, 92, 98, "单福荐卧龙，入曹营终身不设一谋。"),
  G("huang_quan", "黄权", "蜀", "shan", "sorcerer", 7, 58, 86, 105, "巴西名士，夷陵断后，降魏仍见史笔。"),
  ...
  G("ma_liang", "马良", "蜀", "ping", "sorcerer", 6, 38, 88, 96, "白眉最良，入蜀掌文书。"),
  G("chen_dao", "陈到", "蜀", "ping", "infantry", 6, 72, 48, 102, "白毦督，昭烈帐前劲卒。"),
  G("liao_hua", "廖化", "蜀", "shan", "infantry", 6, 68, 52, 105, "历事姜维北伐，蜀中宿将。"),
  G("ma_su", "马谡", "蜀", "shan", "sorcerer", 6, 42, 86, 94, "参军才辩，街亭违令。"),
  G("fei_yi", "费祎", "蜀", "ping", "sorcerer", 7, 36, 88, 98, "宽济相业，续孔明之后。"),
  G("jiang_wan", "蒋琬", "蜀", "ping", "sorcerer", 7, 34, 84, 96, "社稷器量，诸葛亮托以后事。"),
  G("wu_ban", "吴班", "蜀", "shan", "infantry", 6, 72, 50, 102, "夷陵督军，族妹为昭烈穆皇后。"),
  G("dong_yun", "董允", "蜀", "ping", "sorcerer", 6, 40, 80, 94, "掌宫中郎将，匡弼后主。"),
  G("li_yan", "李严", "蜀", "ping", "infantry", 7, 62, 58, 108, "托孤重臣，督江州，后与孔明龃龉。"),
  G("cheng_yu", "程昱", "魏", "ping", "sorcerer", 8, 52, 86, 108, "孟德谋臣，十面埋伏皆出于算。"),
  G("xun_you", "荀攸", "魏", "ping", "sorcerer", 8, 38, 92, 98, "谋主深远，官渡画策。"),
...
/** 演义批量 NPC 中谋士/文士：串里 archer 多为占位，统一为妖术师（与诸葛亮等图鉴一致） */
const NPC_FORCE_SORCERER_NAMES = new Set<string>([
  "孔融",
  "祢衡",
  "陈琳",
  "王粲",
...
function parseNpcSpec(): GeneralCatalogEntry[] {
  ...
  for (let i = 0; i + 3 < parts.length; i += 4) {
    ...
    let troopKind = parts[i + 3]! as TroopKind;
    if (NPC_FORCE_SORCERER_NAMES.has(name)) troopKind = "sorcerer";
