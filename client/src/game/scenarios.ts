    ...
    case "prologue_zhangjiao": {
      ...
      return baseState(
        ...
        [
          ...
          grunt("e_g1", "黄巾术士", 6, 3, 62, 2, 20, 34, 8, "archer", "shui"),
          grunt("e_g2", "黄巾刀兵", 11, 4, 68, 2, 22, 28, 8, "infantry", "ping"),
          grunt("e_g3", "黄巾骑手", 2, 4, 58, 3, 24, 22, 9, "cavalry", "ping"),
        ],
    ...
    case "ch1_pursuit": {
      ...
      return baseState(
        ...
        [
          ...
          grunt("e_x1", "西凉铁骑", 14, 3, 72, 4, 27, 24, 11, "cavalry", "ping"),
          grunt("e_x2", "西凉弓骑", 3, 3, 65, 4, 24, 30, 9, "archer", "ping"),
          grunt("e_x3", "飞熊军", 10, 4, 88, 5, 29, 28, 12, "infantry", "shan"),
          grunt("e_x4", "董府死士", 6, 4, 78, 5, 28, 32, 11, "infantry", "ping"),
        ],
    ...
    case "ch2_xuzhou": {
      ...
      return baseState(
        ...
        [
          ...
          grunt("e_c1", "青州兵", 4, 4, 82, 5, 27, 26, 11, "infantry", "ping"),
          grunt("e_c2", "曹军弩手", 16, 4, 68, 5, 25, 32, 10, "archer", "ping"),
          grunt("e_c3", "虎豹骑斥候", 8, 4, 76, 6, 30, 24, 12, "cavalry", "ping"),
          grunt("e_c4", "辎重营卒", 11, 5, 74, 5, 24, 22, 10, "infantry", "ping"),
        ],
    ...
    case "ch3_xiaopei": {
      ...
      return baseState(
        ...
        [
          ...
          grunt("e_b1", "陷阵营", 7, 4, 92, 7, 30, 26, 13, "infantry", "shan"),
          grunt("e_b2", "并州狼骑", 15, 3, 74, 6, 29, 22, 11, "cavalry", "ping"),
          grunt("e_b3", "方天画戟亲卫", 11, 4, 85, 7, 31, 28, 12, "infantry", "ping"),
          grunt("e_b4", "飞将弓骑", 5, 3, 70, 6, 27, 30, 10, "archer", "ping"),
          grunt("e_b5", "下邳援军", 17, 4, 80, 6, 28, 24, 11, "cavalry", "shan"),
        ],
    ...
    case "ch4_xinye": {
      ...
      return baseState(
        ...
        [
          ...
          grunt("e_n1", "虎豹骑", 16, 2, 78, 7, 31, 22, 12, "cavalry", "ping"),
          grunt("e_n2", "虎豹骑", 6, 2, 76, 7, 30, 22, 12, "cavalry", "ping"),
          grunt("e_n3", "许都弩营", 12, 4, 68, 7, 25, 36, 10, "archer", "ping"),
          grunt("e_n4", "青州射手", 9, 5, 65, 6, 24, 32, 9, "archer", "ping"),
          grunt("e_n5", "曹军精锐", 17, 4, 90, 8, 30, 28, 13, "infantry", "ping"),
          grunt("e_n6", "曹军司马", 5, 4, 95, 8, 29, 34, 12, "infantry", "shan"),
        ],
    ...
    case "ch5_changban": {
      ...
      return baseState(
        ...
        [
          ...
          grunt("e_cb1", "虎豹骑", 20, 2, 82, 8, 32, 22, 13, "cavalry", "ping"),
          grunt("e_cb2", "虎豹骑", 12, 2, 80, 8, 31, 22, 13, "cavalry", "ping"),
          grunt("e_cb3", "虎豹骑", 10, 3, 78, 8, 31, 22, 12, "cavalry", "ping"),
          grunt("e_cb4", "长坂斥候", 8, 2, 70, 7, 27, 28, 10, "archer", "ping"),
          grunt("e_cb5", "曹军别部", 6, 3, 92, 8, 30, 30, 13, "infantry", "ping"),
          grunt("e_cb6", "曹军偏将", 4, 2, 100, 9, 32, 36, 14, "infantry", "shan"),
          grunt("e_cb7", "江岸弩手", 19, 4, 68, 7, 26, 32, 10, "archer", "shui"),
          grunt("e_cb8", "江岸弩手", 7, 4, 66, 7, 25, 30, 10, "archer", "shui"),
        ],
    ...
    case "ch6_chibi": {
      ...
      return baseState(
        ...
        [
          ...
          grunt("e_w1", "江东弩手", 20, 5, 72, 8, 28, 36, 11, "archer", "shui"),
          grunt("e_w2", "连环舟卒", 11, 6, 80, 8, 28, 26, 12, "infantry", "shui"),
          grunt("e_w3", "曹军水卒", 5, 5, 76, 8, 27, 28, 12, "infantry", "shui"),
          grunt("e_w4", "荆州降卒", 9, 4, 82, 9, 29, 28, 12, "archer", "ping"),
          grunt("e_w5", "楼船弓手", 13, 6, 70, 8, 27, 34, 11, "archer", "shui"),
          grunt("e_w6", "浅滩死士", 4, 6, 88, 9, 30, 26, 13, "infantry", "shui"),
        ],
    ...
    case "ch7_yizhou": {
      ...
      return baseState(
        ...
        [
          ...
          grunt("e_yz1", "益州弓手", 12, 6, 76, 9, 29, 32, 12, "archer", "shan"),
          grunt("e_yz2", "剑阁守军", 10, 5, 90, 9, 28, 28, 13, "infantry", "shan"),
          grunt("e_yz3", "益州骑兵", 14, 7, 80, 9, 30, 24, 12, "cavalry", "ping"),
          grunt("e_yz4", "涪城援军", 16, 4, 94, 10, 31, 28, 13, "infantry", "shan"),
          grunt("e_yz5", "栈道甲士", 7, 6, 88, 10, 29, 26, 12, "infantry", "shan"),
          grunt("e_yz6", "益州司马", 2, 5, 120, 11, 33, 42, 15, "infantry", "shan"),
          grunt("e_yz7", "江油戍卒", 18, 6, 78, 9, 27, 30, 11, "archer", "shan"),
        ],
    ...
    case "ch8_hanzhong": {
      ...
      return baseState(
        ...
        [
          ...
          grunt("e_hz1", "魏军骑兵", 18, 2, 86, 11, 33, 24, 13, "cavalry", "ping"),
          grunt("e_hz2", "魏军骑兵", 20, 3, 84, 11, 32, 24, 13, "cavalry", "shan"),
          grunt("e_hz3", "夏侯部曲", 14, 3, 94, 11, 33, 30, 14, "infantry", "ping"),
          grunt("e_hz4", "魏武强弩", 11, 3, 76, 10, 28, 38, 11, "archer", "ping"),
          grunt("e_hz5", "长安精兵", 5, 4, 102, 11, 32, 28, 14, "infantry", "shan"),
          grunt("e_hz6", "魏军参军", 3, 3, 108, 11, 30, 40, 14, "archer", "ping"),
          grunt("e_hz7", "辎重护卫", 17, 4, 88, 10, 29, 26, 12, "infantry", "ping"),
          grunt("e_hz8", "斜谷援军", 21, 4, 92, 11, 31, 28, 13, "cavalry", "ping"),
          grunt("e_hz9", "定军斥候", 6, 5, 72, 10, 27, 32, 11, "archer", "ping"),
          grunt("e_hz10", "汉中垒壁", 8, 6, 96, 11, 30, 26, 13, "infantry", "shan"),
        ],
